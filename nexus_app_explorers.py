...
from nba_backend import (compare_players_data, get_similarity_breakdown, find_player, find_player_suggestions, get_similar_players, get_similarity_with_roles, comparison_df)
...
if st.session_state.page == "Settings":
    ...
    if search:
        ...
        if player is None:
            ...
            similar = get_similarity_with_roles(player["player_name"], 5)
    ...
    table = comparison_df[["player_name", column]].copy()
